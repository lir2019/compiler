...
static void Test1() {
  ...
  std::vector<Token> expected{Token{TokenType::END, ""}};
...
=;(),+{}
  ...
  std::vector<Token> expected{
      Token{TokenType::ASSIGN, "="}, Token{TokenType::SEMICOLON, ";"},
      Token{TokenType::LPAREN, "("}, Token{TokenType::RPAREN, ")"},
      Token{TokenType::COMMA, ","},  Token{TokenType::PLUS, "+"},
...
10 != 9;
  ...
  std::vector<Token> expected{
      ...
      Token{TokenType::NE, "!="},       Token{TokenType::INT, "9"},
